          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8 text-left flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <a
                ...
                className="flex cursor-pointer items-center justify-center gap-2.5 px-6 py-3.5 bg-[#25D366] hover:bg-[#20ba54] active:scale-95 text-white font-bold rounded-full text-sm md:text-base tracking-wide shadow-md hover:shadow-lg transition-all"
                title="WhatsApp এ সরাসরি অর্ডার করুন"
              >
                <svg
                  className="h-5.5 w-5.5 text-white fill-current"
                  viewBox="0 0 24 24"
                >
